...
module.exports = new ButtonInterface({
    ...
    execute: async function(p){
        ...
        .addFields(
            {
                name: "TikTok", value: `${data?.promotion?.tiktok?.link}`, inline: true
            },
            {
                name: `${p.zws}`, value: "", inline: true
            },
            {
                name: `Status`, value: `${data?.promotion?.tiktok?.status}`, inline: true
            }
        )
        ...
        if(data?.promotion?.tiktok?.status === "In Progress"){
