...
module.exports = new ButtonInterface({
    ...
    execute: async function(p){
        ...
        .addFields(
            {
                name: "Twitch", value: `${data?.promotion?.twitch?.link}`, inline: true
            },
            {
                name: `${p.zws}`, value: "", inline: true
            },
            {
                name: `Status`, value: `${data?.promotion?.twitch?.status}`, inline: true
            }
        )
        ...
        if(data?.promotion?.twitch?.status === "In Progress"){
